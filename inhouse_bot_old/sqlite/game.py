...
class Game(sql_alchemy_base):
    ...
    participants = relationship(
        "GameParticipant",
        collection_class=mapped_collection(lambda participant: (participant.team, participant.role)),
        backref="game",
    ...
    def __init__(self, players: dict):
        ...
        self.participants = {
            (team, role): GameParticipant(self, team, role, players[team, role]) for team, role in players
        }
